...
# $bitpar -vp -s TOP em.grammar em.lexicon _corpus -b 1 > _parsed_proba
# cat _parsed_proba | grep -E -o '^[{]*\(TOP=\#i\[P=[0-9]+\.[0-9]*[-e]*[0-9]*\]' | grep -E -o '[0-9]+\.[0-9]*[-e]*[0-9]*' > _output

# # sum to get log-likelihood from file $output
# python ../sum_log_probabilities.py _output